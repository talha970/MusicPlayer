...
public class ArtistsFragment extends BaseFragment implements ArtistsView, OnRecycleObjectClickListener<Artist> {
    ...
    public void showArtistsEmpty() {
        artistsAdapter.setItems(Collections.<Artist>emptyList());
